//! Structural validation of a bundle (`ChangeGroup`) artifact: identity
//! fields, repo entries, commit groups, and the node ledger including
//! per-node-type required fields.
