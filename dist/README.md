...
#    containing `-` (e.g. v0.1.0-alpha.6) is marked as a pre-release.
...
gh release view v0.1.0-alpha.6 --repo marc-merino/knit --json assets -q '.assets[].name'
curl -sL https://github.com/marc-merino/knit/releases/download/v0.1.0-alpha.6/knit-v0.1.0-alpha.6-aarch64-apple-darwin.sha256
