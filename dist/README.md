...
#    containing `-` (e.g. v0.1.0-alpha.8) is marked as a pre-release.
...
gh release view v0.1.0-alpha.8 --repo knit-cli/knit --json assets -q '.assets[].name'
curl -sL https://github.com/knit-cli/knit/releases/download/v0.1.0-alpha.8/knit-v0.1.0-alpha.8-aarch64-apple-darwin.sha256
